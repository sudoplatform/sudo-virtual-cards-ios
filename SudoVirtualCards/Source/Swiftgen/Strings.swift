...
internal enum L10n {
    ...
    internal enum VirtualCards {
      ...
      internal enum Errors {
        ...
        internal static let fundingSourceRequiresUserInteraction = L10n.tr("Localizable", "virtual_cards.errors.fundingSourceRequiresUserInteraction")
        ...
        internal static let invalidKeyArchive = L10n.tr("Localizable", "virtual_cards.errors.invalidKeyArchive")
        ...
        internal static let refreshFailed = L10n.tr("Localizable", "virtual_cards.errors.refreshFailed")
