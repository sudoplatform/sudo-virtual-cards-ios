...
public struct BankAccountFundingSource: BaseFundingSource, Hashable {
    ...
    ///   - unfundedAmount: The amount by which this funding source is unfunded, if at all, in the currency of the funding source
    public init(
        id: String,
        owner: String,
        version: Int,
        ...
        unfundedAmount: CurrencyAmount? = nil
    ) {
        self.id = id
        self.owner = owner
        ...
        self.unfundedAmount = unfundedAmount
    }
