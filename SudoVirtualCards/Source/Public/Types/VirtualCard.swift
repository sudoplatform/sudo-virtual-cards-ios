...
public struct VirtualCard: Hashable {
    ...
    ///   The most recent transaction that occurred on the card. `nil` if no transactions have been performed.
    ...
    public init(
        ...
        self.alias = alias ?? "" // Default to empty String till we can update metadata
        self.last4 = last4
        self.pan = pan
        self.csc = csc
