...
class VirtualCardService {
    ...
    typealias CardList = ListOutput<VirtualCard>
    ...
    init(graphQLClient: SudoApiClient, unsealer: Unsealer, logger: Logger = .virtualCardsSDKLogger) {
    ...
    func create(
        ...
        let request = mutationRequestFromInput(input, clientRefId: clientRefId, ownershipProof: input.ownershipProof, keyRingId: publicKey.keyRingId)
        ...
        return ProvisionalCard.State(data.cardProvision.provisioningState)
    }
    ...
    func mutationRequestFromInput(
        _ input: ProvisionVirtualCardInput,
        clientRefId: String,
